...
export function meta(_args: Route.MetaArgs) {
    return [
        { title: 'Dancer Dashboard - Dance United' },
        { name: 'description', content: 'Your classes and progress' },
    ]
}
                                    ...
                                    {agenda.map(cls => (
                                        <div key={cls.id} className="flex items-center justify-between border-b border-amber-500/10 pb-4 last:border-0 last:pb-0">
                                            ...
                                            <div className="text-right">
                                                <div className="text-xl font-serif text-amber-100">{cls.trainerName}</div>
                                                <div className="text-xs text-gray-500 uppercase tracking-wider">Trainer</div>
                                            </div>
                                        </div>
                                    ))}
                                </div>
