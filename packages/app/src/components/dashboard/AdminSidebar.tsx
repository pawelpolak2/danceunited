  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-2xl border border-amber-900/30 bg-gray-900/40 shadow-2xl shadow-black/50 backdrop-blur-md">
      ...
      <div className="border-amber-900/30 border-t bg-gray-900/50 p-4">
        <Link
          to="/profile"
          className="group flex items-center gap-3 rounded-lg border border-transparent px-3 py-2 font-medium text-gray-400 text-sm transition-colors hover:border-amber-500/10 hover:bg-white/5 hover:text-amber-100"
        >
        ...
        <Form method="post" action="/api/auth/logout">
          <button
            type="submit"
            className="group flex w-full items-center gap-3 rounded-lg border border-transparent px-3 py-2 font-medium text-gray-400 text-sm transition-colors hover:border-red-500/10 hover:bg-red-500/5 hover:text-red-200"
          >
