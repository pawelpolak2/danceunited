...
export function NextClassWidget({ nextClass, userRole }: NextClassProps) {
        ...
        return (
            <div className="relative overflow-hidden rounded-xl border border-amber-500/20 bg-gray-900/40 p-6 backdrop-blur-sm">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center py-6">
                    ...
                    <h3 className="mb-1 font-serif text-xl text-gray-400">No Upcoming Classes</h3>
    ...
    return (
        <div className="group relative overflow-hidden rounded-xl border border-amber-500/30 bg-gradient-to-br from-gray-900/80 to-gray-950/80 p-6 shadow-lg backdrop-blur-md transition-all hover:border-amber-500/50">
            {/* Background Glow */}
            <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-amber-500/10 blur-3xl transition-opacity group-hover:opacity-100" />

            <div className="relative z-10">
                <div className="mb-4 flex items-center justify-between">
                    <div className="rounded-full bg-amber-500/10 px-3 py-1 font-medium text-amber-400 text-xs uppercase tracking-wider border border-amber-500/20">
                ...
                <ShinyText as="h3" variant="heading" className="mb-2 text-2xl font-bold text-white">
                    {nextClass.name}
                </ShinyText>

                {nextClass.trainerName && (
                    <p className="mb-4 text-amber-200/80 font-medium">with {nextClass.trainerName}</p>
                )}
